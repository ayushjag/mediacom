                    ...
                    <div>
                        {isEdit ? (
                            <div className="flex gap-4">
                                ...
                                <button onClick={updateUserProfileData} className="px-6 py-2 rounded-full text-sm font-semibold text-white bg-teal-600 hover:bg-teal-700 transition-all">
                                    Save Changes
                                </button>
                            </div>
                        ) : (
    ...
    <div>
        ...
        {isEdit ? (
            <input 
                ...
                value={value || ''} 
                onChange={onChange} 
                className="w-full bg-gray-100 border border-gray-300 rounded-lg px-3 py-2 transition focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
            />
        ) : (
